      ...
      <nav className="w-full border-b border-neutral-100 bg-white" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, height: 48 }}>
        <div className="max-w-full mx-auto px-4 flex items-center justify-between h-12">
          <div className="flex items-center gap-4">
            ...
            <span className="text-xs font-mono uppercase tracking-widest text-black border-b border-black pb-0.5">Sandbox</span>
            <span className="text-[9px] font-mono text-orange-500 bg-orange-50 px-1.5 py-0.5 rounded">TEST</span>
          </div>
